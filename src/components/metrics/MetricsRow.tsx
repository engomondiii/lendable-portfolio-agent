...
export const MetricsRow: React.FC = () => {
  ...
  return (
    <div className={clsx('grid grid-cols-2 lg:grid-cols-4 gap-3 p-4')}>
      <div className="stagger-item opacity-0 animate-fade-in-up" style={{ animationDelay: '0.05s', animationFillMode: 'forwards' }}>
        <MetricCard
          label="Total Loans"
      ...
      <div className="stagger-item opacity-0 animate-fade-in-up" style={{ animationDelay: '0.10s', animationFillMode: 'forwards' }}>
        <MetricCard
      ...
      <div className="stagger-item opacity-0 animate-fade-in-up" style={{ animationDelay: '0.15s', animationFillMode: 'forwards' }}>
        <MetricCard
          label="PAR0+ Rate"
          ...
          variant={
            metrics
              ? metrics.par0_rate > 0.2
                ? 'danger'
                : metrics.par0_rate > 0.1
                ? 'warning'
                : 'safe'
              : 'default'
          }
      ...
      <div className="stagger-item opacity-0 animate-fade-in-up" style={{ animationDelay: '0.20s', animationFillMode: 'forwards' }}>
        <MetricCard
          ...
          variant={
            metrics
              ? metrics.writeoff_rate > 0.3
                ? 'danger'
                : metrics.writeoff_rate > 0.15
                ? 'warning'
                : 'default'
              : 'default'
          }
